---
description: Use when answering questions about BTIMService or BTIMModule architecture, message flows, API contracts, state machines, or implementation details. Trigger phrases: 架构, 怎么设计, 状态机, 消息流程, API, 如何实现, how does, explain, 依赖关系, 能不能, 为什么.
---
