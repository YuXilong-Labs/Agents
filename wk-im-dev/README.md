...
## 🎉 What's new — v3.5.0 (2026-05-28)

主线主题：**多 agent 并行能力补完 + 主 agent 身份模板重写**。纯 prompt 改动，从 v3.4.x 升级零风险。
