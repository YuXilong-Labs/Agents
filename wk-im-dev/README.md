...
| Claude Code 全局安装 | `/plugin install wk-im-dev@yuxilong-agents`（需先注册 marketplace） |
...
| --- | --- | --- |
| 安装 | `curl bootstrap.sh \| bash` | `/plugin install wk-im-dev@yuxilong-agents` |
...
/plugin uninstall wk-im-dev@yuxilong-agents
