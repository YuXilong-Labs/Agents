...
## 🎉 v1.0.0 — 首个正式版本 (2026-05-28)

> ⚠️ **版本号体系重置**：历史 v3.0.0 → v3.5.0 为开发期内部版本号，已从 GitHub 删除对应 tag。本次同步重置到 v1.0.0，未来按标准 SemVer 演进（bugfix → v1.0.x、行为增强 → v1.x.0、破坏性变更 → v2.0.0）。详见 [CHANGELOG 版本号体系说明](CHANGELOG.md#版本号体系说明)。
...
完整发布说明见 [CHANGELOG v1.0.0](CHANGELOG.md)。
