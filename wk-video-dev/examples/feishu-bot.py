"""
feishu-bot.py — wk-video-dev 飞书 bot 示例

使用 Agent SDK 的 ClaudeSDKClient 接入飞书消息。
wk-video-dev plugin 提供主 agent 身份、skills、hooks 和约束，
无需在 bot 代码中重复定义。
...
def make_options(project_dir: str) -> ClaudeAgentOptions:
    return ClaudeAgentOptions(
        # wk-video-dev plugin provides the main agent identity, skills, and hooks.
