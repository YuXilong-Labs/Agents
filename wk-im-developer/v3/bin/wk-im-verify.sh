...
# Fallback: read host app from workspace config
HOST_APP=""
...
if [ "$ENV" = "main-app" ]; then
  ...
  echo "⚠️  No HostApp configured and no .podspec found. Run /wk-im-developer:setup first."
  exit 1
fi
